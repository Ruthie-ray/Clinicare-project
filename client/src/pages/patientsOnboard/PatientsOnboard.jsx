            ...
            <div className="flex mt-1 md:justify-end pt-3">
              ...
              {currentStep === 2 && (
                <div className="flex justify-end gap-4 ">
                  <button
                    className="btn bg-zinc-800 font-bold text-white  w-full md:w-[120px] cursor-pointer rounded-lg"
                    onClick={handleStep}
                  >
                    {" "}
                    Previous
                  ...
                  <button
                    className="btn bg-blue-500  hover:bg-blue-600 text-white font-bold w-full md:w-[120px] rounded-lg"
                    type="submit"
