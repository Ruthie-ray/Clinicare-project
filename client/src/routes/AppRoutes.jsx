...
const PatientsAppointments = lazy (()  => import("@/pages/dashboard/appointments/PatientsAppointments"));
const PatientsPayments = lazy (()=> import ("@/pages/dashboard/payments/PatientsPayments"))
